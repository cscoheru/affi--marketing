...
创建可复用的逻辑。`,
  ...
  },
  {
    ...
    content: '# AI 内容策略：如何利用 AI 提升内容创作效率\n\n草稿内容...',
    category: categories[1],
    author: authors[0],
    status: 'draft',
