...
export const categories: Category[] = [
  { id: '1', slug: 'technology', name: '技术', description: '探索最新技术趋势和开发实践', color: 'bg-blue-500' },
  { id: '2', slug: 'marketing', name: '营销', description: '数字营销策略和最佳实践', color: 'bg-green-500' },
  { id: '3', slug: 'seo', name: 'SEO', description: '搜索引擎优化技巧和策略', color: 'bg-yellow-500' },
  { id: '4', slug: 'product-reviews', name: '产品测评', description: '深度产品分析和测评', color: 'bg-pink-500' },
  { id: '5', slug: 'tutorials', name: '教程', description: '手把手教程和实战指南', color: 'bg-indigo-500' },
]
...
创建可复用的逻辑。
  ...
  {
    id: '6',
    slug: 'draft-ai-content-strategy',
    title: 'AI 内容策略：如何利用 AI 提升内容创作效率',
    excerpt: '探索如何将 AI 工具融入你的内容创作流程，提高效率同时保持内容质量。',
    content: '草稿内容...',
    category: categories[1],
    author: authors[0],
    status: 'draft',
  ...
  {
    id: '7',
    slug: 'review-email-marketing',
    title: '邮件营销自动化：完整工作流程指南',
    excerpt: '学习如何设置高效的邮件营销自动化流程，提高用户转化率。',
    content: '待审核内容...',
    category: categories[1],
    author: authors[2],
    status: 'review',
